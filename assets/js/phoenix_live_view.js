...
class View {
  ...
  pushChange(inputEl, event, phxEvent) {
    console.log("F")
    console.log(inputEl)
    console.log(event)
    this.pushWithReply("event", {
  ...
  bindUI(){
    ...
    this.eachChild(`[${this.binding("change")}]`, el => this.bindInputChange(el))
  }
  ...
  bindInputChange(el) {
    this.bindOwnAddedNode(el, el, this.binding("change"), phxEvent => {
      el.addEventListener("change", e =>  {
        this.pushChange(el, e, phxEvent)
      })
    })
  }
