defmodule Properties.Repo.Migrations.RenameIndices do
  ...
  def up do
    ...
    execute(
      "ALTER INDEX properties_last_assessment_amount_index_desc RENAME TO assessments_last_assessment_amount_index_desc"
    )
  end
  ...
  def down do
    ...
    execute(
      "ALTER INDEX assessments_last_assessment_amount_index_desc RENAME TO properties_last_assessment_amount_index_desc"
    )
  end
end
