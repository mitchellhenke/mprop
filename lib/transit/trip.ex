defmodule Transit.Trip do
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:feed_id, :trip_id, :route_id, :service_id, :trip_headsign, :direction_id, :block_id, :shape_id])
    |> validate_required([:feed_id, :trip_id, :route_id, :service_id, :direction_id, :block_id, :shape_id])
  ...
  def preload_stop_times(trips) do
    ...
    |> Enum.map(fn(trip) ->
      ...
      speed_mph = Float.round((trip.shape_geom.length_meters / 1609.34) * 60 * 60 / trip.length_seconds, 1)
