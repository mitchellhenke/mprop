defmodule PropertiesWeb.TransitView do
  ...
  def time_for_percentile(trips, stop_time, percentile) do
    ConCache.get_or_store(
      :transit_cache,
      "stop_time_percentile_#{stop_time.trip_id}_#{stop_time.stop_id}_#{percentile}",
      fn ->
        times =
  ...
  def graph(_fastest, trips) do
    ...
    """
    background: linear-gradient(to bottom, #{Map.get(hour_map, "0_color")}, #{
      Map.get(hour_map, "0_color")
      ...
      linear-gradient(to bottom, #{Map.get(hour_map, "10_color")}, #{
      Map.get(hour_map, "10_color")
    }) no-repeat 41.60% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "11_color")}, #{
      Map.get(hour_map, "11_color")
    }) no-repeat 45.76% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "12_color")}, #{
      Map.get(hour_map, "12_color")
    }) no-repeat 49.92% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "13_color")}, #{
      Map.get(hour_map, "13_color")
    }) no-repeat 54.08% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "14_color")}, #{
      Map.get(hour_map, "14_color")
    }) no-repeat 58.24% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "15_color")}, #{
      Map.get(hour_map, "15_color")
    }) no-repeat 62.40% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "16_color")}, #{
      Map.get(hour_map, "16_color")
    }) no-repeat 66.56% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "17_color")}, #{
      Map.get(hour_map, "17_color")
    }) no-repeat 70.72% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "18_color")}, #{
      Map.get(hour_map, "18_color")
    }) no-repeat 74.88% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "19_color")}, #{
      Map.get(hour_map, "19_color")
    }) no-repeat 79.04% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "20_color")}, #{
      Map.get(hour_map, "20_color")
    }) no-repeat 83.20% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "21_color")}, #{
      Map.get(hour_map, "21_color")
    }) no-repeat 87.36% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "22_color")}, #{
      Map.get(hour_map, "22_color")
    }) no-repeat 91.52% bottom,
      linear-gradient(to bottom, #{Map.get(hour_map, "23_color")}, #{
      Map.get(hour_map, "23_color")
    }) no-repeat 95.68% bottom;
